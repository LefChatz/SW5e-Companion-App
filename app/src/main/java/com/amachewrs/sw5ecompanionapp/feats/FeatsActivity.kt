...
class FeatsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.reclview.adapter = featAdapter
    ...
    fun returnToMain() {
        if (!atInfo){
            favSharedPreferences.edit { putStringSet("favorite_feats", favFeatList.toMutableSet()) }
            finish()
        }
