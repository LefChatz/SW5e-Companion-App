            ...
            "Bulwark Technique"->{
                for(i in bulwarkList.indices step 2 ){
                    if(i==0){
                        ...
                        tempView = inflater.inflate(R.layout.universal_title_goldbar_text_textview,ll,false)
                        temptxt=tempView.findViewById(R.id.contenttext)
                        tempView.findViewById<TextView>(R.id.headertext).text=bulwarkList[i-1]
            ...
            "Hunter Technique"->{
                for(i in hunterList.indices step 2 ){
                    if(i==0){
                        ...
                        tempView = inflater.inflate(R.layout.universal_title_goldbar_text_textview,ll,false)
                        temptxt=tempView.findViewById(R.id.contenttext)
                        tempView.findViewById<TextView>(R.id.headertext).text=hunterList[i-1]
            ...
            "Slayer Technique"->{
                for(i in slayerList.indices step 2 ){
                    if(i==0){
                        ...
                        tempView = inflater.inflate(R.layout.universal_title_goldbar_text_textview,ll,false)
                        temptxt=tempView.findViewById(R.id.contenttext)
                        tempView.findViewById<TextView>(R.id.headertext).text=slayerList[i-1]
            ...
            "Stalker Technique"->{
                for(i in stalkerList.indices step 2 ){
                    if(i==0){
                        ...
                        tempView = inflater.inflate(R.layout.universal_title_goldbar_text_textview,ll,false)
                        temptxt=tempView.findViewById(R.id.contenttext)
                        tempView.findViewById<TextView>(R.id.headertext).text=stalkerList[i-1]
