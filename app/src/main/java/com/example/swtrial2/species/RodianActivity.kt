...
class RodianActivity : AppCompatActivity() , GestureDetector.OnGestureListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.species_rodian)

        inflater = layoutInflater
        gestdect = GestureDetector(this,this)

        scrolly = findViewById(R.id.rodianscrollview)
        coordl = findViewById(R.id.coordlayout)
        ll = findViewById(R.id.rodianll)
    ...
    private fun changeview(){
        ...
        if (dummybutton.text.toString() == "Info") {
            ...
            tempview.findViewById<TextView>(R.id.headertext).text=getText(R.string.rodian_traitsHeader)
            tempview.findViewById<TextView>(R.id.contenttext).text=getText(R.string.rodian_traitsText)
            ll.addView(tempview)
            dummybutton.text = getText(R.string.traits)
            mode=1
        } else {
            inflater.inflate(R.layout.species_rodian_info, ll, true)
