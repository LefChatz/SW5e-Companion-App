...
class ZabrakActivity : AppCompatActivity() , GestureDetector.OnGestureListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.species_zabrak)

        inflater = layoutInflater
        gestdect = GestureDetector(this,this)

        scrolly = findViewById(R.id.zabrakscrollview)
        coordl = findViewById(R.id.coordlayout)
        ll = findViewById(R.id.zabrakll)
    ...
    private fun changeview(){
        ...
        if (dummybutton.text.toString() == "Info") {
            ...
            tempview.findViewById<TextView>(R.id.headertext).text=getText(R.string.zabrak_traitsHeader)
            tempview.findViewById<TextView>(R.id.contenttext).text=getText(R.string.zabrak_traitsText)
            ll.addView(tempview)
            dummybutton.text = getText(R.string.traits)
            mode=1
        } else {
            inflater.inflate(R.layout.species_zabrak_info, ll, true)
