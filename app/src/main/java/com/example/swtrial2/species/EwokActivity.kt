...
class EwokActivity : AppCompatActivity() , GestureDetector.OnGestureListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.species_ewok)

        inflater = layoutInflater
        gestdect = GestureDetector(this,this)

        scrolly = findViewById(R.id.ewokscrollview)
        coordl = findViewById(R.id.coordlayout)
        ll = findViewById(R.id.ewokll)
    ...
    private fun changeview(){
        ...
        if (dummybutton.text.toString() == "Info") {
            ...
            tempview.findViewById<TextView>(R.id.headertext).text=getText(R.string.ewok_traitsHeader)
            tempview.findViewById<TextView>(R.id.contenttext).text=getText(R.string.ewok_traitsText)
            ll.addView(tempview)
            dummybutton.text = getText(R.string.traits)
            mode=1
        } else {
            inflater.inflate(R.layout.species_ewok_info, ll, true)
