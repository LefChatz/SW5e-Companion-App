...
class DroidClass3Activity : AppCompatActivity() , GestureDetector.OnGestureListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.species_droid_class3)

        inflater = layoutInflater
        gestdect = GestureDetector(this,this)

        scrolly = findViewById(R.id.droid_class3scrollview)
        coordl = findViewById(R.id.coordlayout)
        ll = findViewById(R.id.droid_class3ll)
    ...
    private fun changeview(){
        ...
        if (dummybutton.text.toString() == "Info") {
            ...
            tempview.findViewById<TextView>(R.id.headertext).text=getText(R.string.droid_class3_traitsHeader)
            tempview.findViewById<TextView>(R.id.contenttext).text=getText(R.string.droid_class3_traitsText)
            ll.addView(tempview)
            dummybutton.text = getText(R.string.traits)
            mode=1
        } else {
            inflater.inflate(R.layout.species_droid_class3_info, ll, true)
