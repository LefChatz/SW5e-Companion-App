...
class KelDorActivity : AppCompatActivity() , GestureDetector.OnGestureListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.species_kel_dor)

        inflater = layoutInflater
        gestdect = GestureDetector(this,this)

        scrolly = findViewById(R.id.kel_dorscrollview)
        coordl = findViewById(R.id.coordlayout)
        ll = findViewById(R.id.kel_dorll)
    ...
    private fun changeview(){
        ...
        if (dummybutton.text.toString() == "Info") {
            ...
            tempview.findViewById<TextView>(R.id.headertext).text=getText(R.string.kel_dor_traitsHeader)
            tempview.findViewById<TextView>(R.id.contenttext).text=getText(R.string.kel_dor_traitsText)
            ll.addView(tempview)
            dummybutton.text = getText(R.string.traits)
            mode=1
        } else {
            inflater.inflate(R.layout.species_kel_dor_info, ll, true)
