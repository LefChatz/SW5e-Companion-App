...
class MonCalamariActivity : AppCompatActivity() , GestureDetector.OnGestureListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.species_mon_calamari)

        inflater = layoutInflater
        gestdect = GestureDetector(this,this)

        scrolly = findViewById(R.id.mon_calamariscrollview)
        coordl = findViewById(R.id.coordlayout)
        ll = findViewById(R.id.mon_calamarill)
    ...
    private fun changeview(){
        ...
        if (dummybutton.text.toString() == "Info") {
            ...
            tempview.findViewById<TextView>(R.id.headertext).text=getText(R.string.mon_calamari_traitsHeader)
            tempview.findViewById<TextView>(R.id.contenttext).text=getText(R.string.mon_calamari_traitsText)
            ll.addView(tempview)
            dummybutton.text = getText(R.string.traits)
            mode=1
        } else {
            inflater.inflate(R.layout.species_mon_calamari_info, ll, true)
