...
class BothanActivity : AppCompatActivity() , GestureDetector.OnGestureListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.species_bothan)

        inflater = layoutInflater
        gestdect = GestureDetector(this,this)

        scrolly = findViewById(R.id.bothanscrollview)
        coordl = findViewById(R.id.coordlayout)
        ll = findViewById(R.id.bothanll)
    ...
    private fun changeview(){
        ...
        if (dummybutton.text.toString() == "Info") {
            tempview = inflater.inflate(R.layout.class_textview,ll,false)
            tempview.findViewById<TextView>(R.id.headertext).text=getText(R.string.bothan_traitsHeader)
            tempview.findViewById<TextView>(R.id.contenttext).text=getText(R.string.bothan_traitsText)
            ll.addView(tempview)
            ...
            inflater.inflate(R.layout.species_bothan_info, ll, true)
            dummybutton.text = getText(R.string.info)
            mode=0
        }
