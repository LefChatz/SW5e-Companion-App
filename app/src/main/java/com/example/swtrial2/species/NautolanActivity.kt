...
class NautolanActivity : AppCompatActivity() , GestureDetector.OnGestureListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.species_nautolan)

        inflater = layoutInflater
        gestdect = GestureDetector(this,this)

        scrolly = findViewById(R.id.nautolanscrollview)
        coordl = findViewById(R.id.coordlayout)
        ll = findViewById(R.id.nautolanll)
    ...
    private fun changeview(){
        ...
        if (dummybutton.text.toString() == "Info") {
            ...
            tempview.findViewById<TextView>(R.id.headertext).text=getText(R.string.nautolan_traitsHeader)
            tempview.findViewById<TextView>(R.id.contenttext).text=getText(R.string.nautolan_traitsText)
            ll.addView(tempview)
            dummybutton.text = getText(R.string.traits)
            mode=1
        } else {
            inflater.inflate(R.layout.species_nautolan_info, ll, true)
