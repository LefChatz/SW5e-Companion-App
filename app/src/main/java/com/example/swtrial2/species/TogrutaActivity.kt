...
class TogrutaActivity : AppCompatActivity() , GestureDetector.OnGestureListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.species_togruta)

        inflater = layoutInflater
        gestdect = GestureDetector(this,this)

        scrolly = findViewById(R.id.togrutascrollview)
        coordl = findViewById(R.id.coordlayout)
        ll = findViewById(R.id.togrutall)
    ...
    private fun changeview(){
        ...
        if (dummybutton.text.toString() == "Info") {
            ...
            tempview.findViewById<TextView>(R.id.headertext).text=getText(R.string.togruta_traitsHeader)
            tempview.findViewById<TextView>(R.id.contenttext).text=getText(R.string.togruta_traitsText)
            ll.addView(tempview)
            dummybutton.text = getText(R.string.traits)
            mode=1
        } else {
            inflater.inflate(R.layout.species_togruta_info, ll, true)
