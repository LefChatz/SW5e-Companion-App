...
class JawaActivity : AppCompatActivity() , GestureDetector.OnGestureListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.species_jawa)

        inflater = layoutInflater
        gestdect = GestureDetector(this,this)

        scrolly = findViewById(R.id.jawascrollview)
        coordl = findViewById(R.id.coordlayout)
        ll = findViewById(R.id.jawall)
    ...
    private fun changeview(){
        ...
        if (dummybutton.text.toString() == "Info") {
            ...
            tempview.findViewById<TextView>(R.id.headertext).text=getText(R.string.jawa_traitsHeader)
            tempview.findViewById<TextView>(R.id.contenttext).text=getText(R.string.jawa_traitsText)
            ll.addView(tempview)
            dummybutton.text = getText(R.string.traits)
            mode=1
        } else {
            inflater.inflate(R.layout.species_jawa_info, ll, true)
