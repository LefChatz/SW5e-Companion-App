...
class SithPurebloodActivity : AppCompatActivity() , GestureDetector.OnGestureListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.species_sith_pureblood)

        inflater = layoutInflater
        gestdect = GestureDetector(this,this)

        scrolly = findViewById(R.id.sith_purebloodscrollview)
        coordl = findViewById(R.id.coordlayout)
        ll = findViewById(R.id.sith_purebloodll)
    ...
    private fun changeview(){
        ...
        if (dummybutton.text.toString() == "Info") {
            ...
            tempview.findViewById<TextView>(R.id.headertext).text=getText(R.string.sith_pureblood_traitsHeader)
            tempview.findViewById<TextView>(R.id.contenttext).text=getText(R.string.sith_pureblood_traitsText)
            ll.addView(tempview)
            dummybutton.text = getText(R.string.traits)
            mode=1
        } else {
            inflater.inflate(R.layout.species_sith_pureblood_info, ll, true)
