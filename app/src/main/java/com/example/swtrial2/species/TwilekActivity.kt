...
class TwilekActivity : AppCompatActivity() , GestureDetector.OnGestureListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.species_twilek)

        inflater = layoutInflater
        gestdect = GestureDetector(this,this)

        scrolly = findViewById(R.id.twilekscrollview)
        coordl = findViewById(R.id.coordlayout)
        ll = findViewById(R.id.twilekll)
    ...
    private fun changeview(){
        ...
        if (dummybutton.text.toString() == "Info") {
            ...
            tempview.findViewById<TextView>(R.id.headertext).text=getText(R.string.twilek_traitsHeader)
            tempview.findViewById<TextView>(R.id.contenttext).text=getText(R.string.twilek_traitsText)
            ll.addView(tempview)
            dummybutton.text = getText(R.string.traits)
            mode=1
        } else {
            inflater.inflate(R.layout.species_twilek_info, ll, true)
