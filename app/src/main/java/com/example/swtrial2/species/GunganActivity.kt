...
class GunganActivity : AppCompatActivity() , GestureDetector.OnGestureListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.species_gungan)

        inflater = layoutInflater
        gestdect = GestureDetector(this,this)

        scrolly = findViewById(R.id.gunganscrollview)
        coordl = findViewById(R.id.coordlayout)
        ll = findViewById(R.id.gunganll)
    ...
    private fun changeview(){
        ...
        if (dummybutton.text.toString() == "Info") {
            ...
            tempview.findViewById<TextView>(R.id.headertext).text=getText(R.string.gungan_traitsHeader)
            tempview.findViewById<TextView>(R.id.contenttext).text=getText(R.string.gungan_traitsText)
            ll.addView(tempview)
            dummybutton.text = getText(R.string.traits)
            mode=1
        } else {
            inflater.inflate(R.layout.species_gungan_info, ll, true)
