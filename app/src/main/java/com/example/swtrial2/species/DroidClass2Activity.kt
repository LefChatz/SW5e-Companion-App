...
class DroidClass2Activity : AppCompatActivity() , GestureDetector.OnGestureListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.species_droid_class2)

        inflater = layoutInflater
        gestdect = GestureDetector(this,this)

        scrolly = findViewById(R.id.droid_class2scrollview)
        coordl = findViewById(R.id.coordlayout)
        ll = findViewById(R.id.droid_class2ll)
    ...
    private fun changeview(){
        ...
        if (dummybutton.text.toString() == "Info") {
            ...
            tempview.findViewById<TextView>(R.id.headertext).text=getText(R.string.droid_class2_traitsHeader)
            tempview.findViewById<TextView>(R.id.contenttext).text=getText(R.string.droid_class2_traitsText)
            ll.addView(tempview)
            dummybutton.text = getText(R.string.traits)
            mode=1
        } else {
            inflater.inflate(R.layout.species_droid_class2_info, ll, true)
