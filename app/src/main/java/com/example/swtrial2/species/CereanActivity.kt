...
class CereanActivity : AppCompatActivity() , GestureDetector.OnGestureListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.species_cerean)

        inflater = layoutInflater
        gestdect = GestureDetector(this,this)

        scrolly = findViewById(R.id.cereanscrollview)
        coordl = findViewById(R.id.coordlayout)
        ll = findViewById(R.id.cereanll)
    ...
    private fun changeview(){
        ...
        if (dummybutton.text.toString() == "Info") {
            ...
            tempview.findViewById<TextView>(R.id.headertext).text=getText(R.string.cerean_traitsHeader)
            tempview.findViewById<TextView>(R.id.contenttext).text=getText(R.string.cerean_traitsText)
            ll.addView(tempview)
            dummybutton.text = getText(R.string.traits)
            mode=1
        } else {
            inflater.inflate(R.layout.species_cerean_info, ll, true)
